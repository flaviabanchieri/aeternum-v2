...
class _AlterarSenhaWidgetState extends State<AlterarSenhaWidget>
  ...
  void initState() {
    ...
    _model.passwordConfirmedTextController ??= TextEditingController();
    _model.passwordConfirmedFocusNode ??= FocusNode();
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 12.0, 0.0, 24.0),
                                  child: Text(
                                    'Altere a senha padrão para continuar',
                                    textAlign: TextAlign.center,
                                    style: FlutterFlowTheme.of(context)
                                        .labelLarge
                                        .override(
                                          ...
                                          Expanded(
                                            child: Padding(
                                              ...
                                              child: Container(
                                                ...
                                                child: TextFormField(
                                                  controller: _model
                                                      .passwordConfirmedTextController,
                                                  focusNode: _model
                                                      .passwordConfirmedFocusNode,
                                                  autofocus: false,
                                                  obscureText: !_model
                                                      .passwordConfirmedVisibility,
                                                  decoration: InputDecoration(
                                                    labelText:
                                                        'Confirmar Senha',
                                                    labelStyle: FlutterFlowTheme
